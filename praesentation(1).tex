...
Bekannte \textbf{Elementarlösung} -- Punktquelle mit Stärke $m$:
\vspace{-2mm}
\[
  \varphi = \frac{m}{2\pi}\ln r
  \qquad\text{erfüllt}\quad \Delta\varphi = 0
\]

\vspace{-4mm}
Weil die Laplace-Gl.\ \textbf{linear} ist, erfüllt jede
Überlagerung sie ebenfalls.
$\to$ Kontur in $n$ \textbf{Panele} unterteilen, auf jedem
Quellen ansetzen -- $\Delta\varphi=0$ ist automatisch
erfüllt, nur die Randbedingung bleibt zu bestimmen.
